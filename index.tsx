...
import { RegisterAdminPage } from './components/auth/RegisterAdminPage'; // Added
...
const App: React.FC = () => {
  return (
    <Routes>
      ...
      <Route path="/register-organization" element={<RegisterAdminPage />} /> {/* Added registration route */}
