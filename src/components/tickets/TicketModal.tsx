  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={modalTitle} size="lg">
      <form onSubmit={handleSubmit} className="space-y-4" aria-labelledby="ticket-modal-title">
        ...
        <Input label="Requester Info (Name, Email, etc.)" id="requester_info" name="requester_info" value={ticketData.requester_info || ''} onChange={handleChange} error={errors.requester_info} required disabled={isLoading || !isEditing} />
