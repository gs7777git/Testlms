...
// import { StatCard } from './ReportsPage'; // Assuming StatCard is common, or define locally if specific
...
// Local definition of StatCard if not imported from a common place
const StatCard: React.FC<{ title: string; value: string | number | undefined; linkTo?: string, icon?: React.ReactNode }> = ({ title, value, linkTo, icon }) => (
