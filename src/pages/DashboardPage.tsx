      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-secondary-500">
            ...
            {activity.lead_id ? (
                 <Link to={`/leads`} state={{ preselectLeadId: activity.lead_id, viewMode: true, activeTab: 'activities' }} className="text-primary-600 hover:underline">
        ...
        {activity.lead_id && (
            <Link to={`/leads`} state={{ preselectLeadId: activity.lead_id, viewMode: true, activeTab: 'activities' }} className="text-primary-600 hover:text-primary-700" title="View Lead">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-secondary-900">
                <Link to={`/leads`} state={{ preselectLeadId: followup.lead_id, viewMode: true, activeTab: 'follow_ups' }} className="hover:underline">
        ...
        <Link to={`/leads`} state={{ preselectLeadId: followup.lead_id, viewMode: true, activeTab: 'follow_ups' }} className="text-primary-600 hover:text-primary-700" title="View Lead & Manage Follow-up">
            <EyeIcon className="h-5 w-5"/>
        </Link>
      </div>
    </li>
