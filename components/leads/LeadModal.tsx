...
import { PlusIcon, EditIcon, DeleteIcon, TagIcon, EyeIcon } from '@/components/common/Icons';
  ...
  useEffect(() => {
    if (isOpen) {
        if (leadToEdit) {
            ...
            setLeadData(prev => ({ ...initialLeadState, owner_user_id: currentUserProfile?.id || null }));
            setContactsForCompany([]);
        }
    } else {
        resetFormStates(); 
